...
{
    public function doTeachingEvaluation($studentID, $password, $cookie)
    {
        (new Login())->doLogin($studentID, $password, $cookie);
        $result = $this->batchEvaluation($cookie);
        return $result;
    }
     ...
     */
    private function batchEvaluation($cookie)
    {
        ////进入学生评价页面
    ...
    //对单个老师进行评价
    private function doOneTeachingEvaluation($url, $cookie)
    {
        ...
        $post =
            ...
            'pj02id=' . $pj02id . '&' .
            'pj06xh=' . '2' . '&' .
            'pj0601id_2=' . '3BDB446C22734745AFFE9DF8AC722654' . '&' .
            ...
            'pj06xh=' . '3' . '&' .
            'pj0601id_3=' . 'BC0B807090BD4163977B56CE2157FEBF' . '&' .
            ...
            'pj06xh=' . '4' . '&' .
            'pj0601id_4=' . 'C313744F32C546548964DD5A2F48E575' . '&' .
            ...
            'pj06xh=' . '5' . '&' .
            'pj0601id_5=' . '4C8C79FF13C74919A0414D0BA6BA6139' . '&' .
            ...
            'pj06xh=' . '1' . '&' .
            'pj0601id_1=' . 'B4575D7DA61E4B8E8F2B3A3E99403B69' . '&' .
            ...
            'pj0601id_6=' . '48D5096B044D4A6782BB77DF449CBDD5' . '&' .
